      ...
      <div className="container mx-auto px-4 py-6">
        <Breadcrumb
          items={[
            ...
            { label: "4-Tier Chrome Wire Shelving Unit" },
          ]}
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-6">
          ...
          {/* Details */}
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold mb-2">4-Tier Chrome Wire Shelving Unit</h1>
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-muted-foreground">Starting from</span>
              <span className="text-xl font-bold">BDT 12,500</span>
              <span className="text-muted-foreground line-through">BDT 15,000</span>
            </div>
